        ...
        <div class="container">
            <div class="row">
                <div class=" col-12 col-md-5 col-lg-5 ">
                    ...
                    <div class="stt">
                            <?php
                                ...
                                //b2: truy vấn
                                    $sql=  'select * from information WHERE  id_information = 2 ';
                ...
                <div class=" col-md-7 col-lg-7 bg-white">
                    <div class="content-1">
                        <h2>NGUYEN THI YEN NHI</h2>
                        <p>
                            <?php
                                require("config-csdl.php");
                                //b2: truy vấn
                                    $sql=  'select * from introduce WHERE id_introduce=2 ';
                    ...
                    <div class="content-1">
                        <p>
                            <?php
                                    require("config-csdl.php");
                                    //b2: truy vấn
                                        $sql=  'select * from target WHERE id_target=2 ';
                    ...
                    <div class="content-1">
                        ...
                        <?php
                                require("config-csdl.php");
                                //b2: truy vấn
                                    $sql=  'select * from education WHERE id_education=5 ';
                            ...
                            <?php
                                require("config-csdl.php");
                                //b2: truy vấn
                                    $sql=  'select * from education WHERE id_education=6';
                            ...
                            <?php
                                require("config-csdl.php");
                                //b2: truy vấn
                                    $sql=  'select * from education WHERE id_education=7 ';
                            ...
                            <?php
                                require("config-csdl.php");
                                //b2: truy vấn
                                    $sql=  'select * from education WHERE id_education=8';
                    ...
                    <div class="me">
                        <li><i class="fab fa-facebook icon"></i><a
                                href="https://www.facebook.com/profile.php?id=100008951924010"
                                class="fb">facebook.com/nguyenthiyennhi</a></li>
                        <li><i class="fab fa-instagram icon"></i><a href="https://www.instagram.com/nguyenthiyennhi2k/"
                                class="fb">nguyenthiyennhi2k</a></li>
                    </div>
